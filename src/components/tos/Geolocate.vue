<template lang="pug">
  <div id="terms">
    <div class="terms-wrapper">
        <h1>{{ companyShort }} {{ geolocate }}</h1>


        <h3>제1조 (목적)</h3>
        <p>본 약관은 회원(본 약관에 동의한 자를 말합니다. 이하 '회원'이라고 합니다)이 {{ companyKo }} (이하 '회사'라고 합니다)가 제공하는 위치기반서비스(이하 '서비스'라고 합니다)를 이용함에 있어 회사와 회원의 권리・의무 및 책임사항을 규정함을 목적으로 합니다.
        </p>
        ...
        <h3>제3조 (약관 외 준칙)</h3>
        <p>본 약관에 규정되지 않은 사항에 대해서는 위치정보의 보호 및 이용 등에 관한 법률(이하 '위치정보법'이라고 합니다), 전기통신사업법, 정보통신망 이용촉진 및 보호 등에 관한 법률(이하 '정보통신망법'이라고 합니다), 개인정보보호법 등 관련법령 또는 회사가 정한 서비스의 운영정책 및 규칙 등(이하 '세부지침'이라고 합니다)의 규정에 따릅니다.
        </p>


        <h3>제4조 (서비스의 가입)</h3>
        <p>본 회사는 아래와 같은 경우에는 계정 생성을 유보할 수 있습니다.
        </p>
        <ol class="terms-list">
        ...
        <h3>제6조 (서비스의 해지)</h3>
        <p>회원이 서비스 이용을 해지하고자 할 경우 회원은 회사가 정한 절차(모바일 소프트웨어, 전자우편 등을 통한 공지)를 통해 서비스 해지를 신청할 수 있으며, 회사는 법령이 정하는 바에 따라 신속히 처리합니다.
        </p>


        <h3>제7조 (서비스의 내용)</h3>
        <p>회사가 제공하는 서비스는 아래와 같습니다.
        </p>
            <ol class="terms-list">
        ...
        <h3>제15조 (양도금지)</h3>
        <p>회원의 서비스 받을 권리는 이를 양도 내지 증여하거나 담보제공 등의 목적으로 처분할 수 없습니다.
        </p>
